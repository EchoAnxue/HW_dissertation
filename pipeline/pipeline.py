...
def run_pipeline(dataset_name="Cora",
                 ...
                 model_types=[ "GraphSAGE", "resGCN","GINConv"],
                 # 2,8,32
                 num_layers_list=[8], batch=False):
    ...
    data = dataset[0]
    # bs 512 2048
    train_loader, val_loader, test_loader = loader(data, batch_size=256)
    results = {}
    parameter = []
...
if __name__ == "__main__":
        results, parameters = run_pipeline()
